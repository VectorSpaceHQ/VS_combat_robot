...
teeth = 70;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
...
motor_shaft = 22.3;	// NEMA17 motor shaft exact diameter = 5
...
pulley_t_ht = 6.3;	// length of toothed part of pulley, standard = 12
...
//	translate ([0,0, pulley_b_ht + pulley_t_ht + retainer_ht ]) rotate ([0,180,0])
	...
	difference()
	 {	 
		...
		translate([0,0,-4])cylinder(r=motor_shaft/2,h=pulley_b_ht + pulley_t_ht + retainer_ht + 12,$fn=motor_shaft*4);
