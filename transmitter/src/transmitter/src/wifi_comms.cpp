...
bool sendCommand(Joystick leftJoystick, Joystick rightJoystick, uint16_t weaponSpeed, uint16_t servo_position) {
    commandMessage.id++;
    ...
    commandMessage.servo_position = servo_position;
